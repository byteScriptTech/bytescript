...
export default function CodeEditor() {
  ...
  const renderOutput = (isMobile = false) => (
    <div className={`flex-1 flex flex-col ${!isMobile ? 'h-full' : 'h-48'}`}>
      ...
      <div
        ref={outputRef}
        className={`overflow-auto p-4 text-sm bg-white ${!isMobile ? 'h-full' : 'h-48'}`}
      >
        {result ? (
  ...
  return (
    <div className="flex flex-col h-full p-4 bg-gray-100">
      ...
      <div className="hidden md:block flex-1 rounded-lg overflow-hidden border border-gray-200 bg-white shadow-sm">
        <PanelGroup direction="horizontal">
          <Panel defaultSize={50} minSize={30} className="flex flex-col">
            {renderEditor()}
          </Panel>
          <PanelResizeHandle className="w-1 bg-gray-100 hover:bg-blue-200 transition-colors" />
          <Panel defaultSize={50} minSize={30} className="flex flex-col">
            {renderOutput()}
          </Panel>
        </PanelGroup>
      ...
      <div className="md:hidden flex-1 flex flex-col rounded-lg overflow-hidden border border-gray-200 bg-white shadow-sm">
        <PanelGroup direction="vertical">
          <Panel defaultSize={60} minSize={30} className="flex flex-col">
            {renderEditor(true)}
          </Panel>
          <PanelResizeHandle className="h-2 bg-gray-100 hover:bg-blue-100 transition-colors flex items-center justify-center">
